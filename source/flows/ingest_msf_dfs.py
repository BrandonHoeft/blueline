...
This flow handles the main DFS data ingestion (slate, player, game, salary, actual points)
...
@flow(name="ingest-msf-dfs-flow")
def ingest_msf_dfs_flow(
...
if __name__ == "__main__":
    ...
    ingest_msf_dfs_flow.serve(
        name="ingest-msf-dfs-flow-deployment",
        parameters={
